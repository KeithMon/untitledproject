...
$config['forgot_password_expiration'] = 10800; //3 hours     // The number of miliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
